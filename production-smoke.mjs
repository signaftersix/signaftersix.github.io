...
assert(app.includes("lastRoutedAddress"));
assert(read("index.html").includes('id="address" name="address" autocomplete="street-address" placeholder="Street address, city, FL ZIP" required'));
...
const routeService = read("supabase/functions/route-service-address/index.ts");
assert(routeService.includes("OUTSIDE_FLORIDA"));
